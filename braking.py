...
def braking_rec(message, uarts=None):
    ...
    #print(message)
    mylogging.add_to_log(message, 'braking')
    ...
    if len(values) != 13:
        print("Expected 13 values in the string")
        mylogging.add_to_log("Expected 13 values in the string", "braking")
        return
    ...
    try:
        ...
        print(f"Error in braking string: {str(e)}")
        mylogging.add_to_log(f"Error in braking string: {str(e)}", "braking")
        return
